...
custom_device_xml = r"C:\Users\Linh\Desktop\Fraunhofer\genicam\MER2-160-75GC(169.254.48.129[00-21-49-05-EE-A2]).XML" #not necessary if device preconfig with GalaxyViewer
ia = h.create_image_acquirer(0, file_path=custom_device_xml)
